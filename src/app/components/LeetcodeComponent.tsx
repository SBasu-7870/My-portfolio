        ...
        <div className="flex flex-row gap-x-11 justify-between mt-5">
          ...
          <div className="flex flex-col grow mx-5 -translate-y-5">
            ...
            <ProgressBar
                ...
                borderRadius={6}
                progress={(data.easySolved/data.totalEasy) * 100}
                height={10}
              />
            ...
            <ProgressBar
                ...
                borderRadius={5}
                progress={(data.mediumSolved/data.totalMedium)*100}
                height={10}
              />
            <div className="flex justify-between my-2">
            ...
            <ProgressBar
                ...
                borderRadius={5}
                progress={(data.hardSolved/data.totalHard)*100}
                height={10}
              />
          </div>
        </div>
